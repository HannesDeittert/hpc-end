...
@dataclass
class j_shaped_AmplatzSuperStiff(Device):
    # Candidate backlog wire:
    # j_shaped_AmplatzSuperStiff
    name: str = "amplatz_super_stiff_jshaped"
    ...
    young_modulus_tip: float = 424.0
    young_modulus_straight: float = 2436.0
