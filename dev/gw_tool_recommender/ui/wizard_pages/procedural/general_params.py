# ui/wizard_pages/procedural/general_params.py
...
class GeneralParamsPage(QWizardPage):
    def __init__(self, parent: QWidget = None):
        ...
        self.setSubTitle("Enter basic information for your procedural device.")
        ...
        self.registerField("procName*", self.name_edit)
        ...
        self.registerField("procDesc", self.desc_edit)
