...
from steve_recommender.ui.components.tool_detail import ToolDetailDialog
from steve_recommender.ui.wizard import ToolWizard
...
class ModelDetailDialog(QDialog):
    def __init__(self, model_name: str, parent=None):
        ...
        if def_path.exists():
            from steve_recommender.storage import read_json
