...
class JShapedAmplatzSuperStiffTightJSimple(eve.intervention.device.JShaped):
    def __init__(self):
        super().__init__(
            name="amplatz_super_stiff_jshaped_tight_j",
            velocity_limit=(35.0, 3.14),
            length=450.0,
            tip_radius=TIGHT_J_TIP_RADIUS_MM,
            tip_angle=BASELINE_TIP_LENGTH_MM / TIGHT_J_TIP_RADIUS_MM,
